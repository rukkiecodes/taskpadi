<template>
  <vs-dialog blur scroll not-center width="500px" overflow-hidden prevent-close
    ...
    <div class="con-content">
      <v-row justify="space-between" align="start">
        ...
        <v-col cols="12" sm="6">
          <vs-input block placeholder="Price" v-model="transaction.updateTransactionCredential.price" />
        </v-col>
        <v-col cols="12" sm="6">
          <vs-input block placeholder="Quantity" v-model="transaction.updateTransactionCredential.quantity" />
        </v-col>
        <v-col cols="12" sm="6">
          <vs-select block placeholder="Role" v-model="transaction.updateTransactionCredential.role">
            <vs-option label="Buyer" value="buyer"> Buyer </vs-option>
            <vs-option label="Seller" value="seller"> Seller </vs-option>
          </vs-select>
        </v-col>
        <v-col cols="12" sm="6">
          <vs-input block type="number" placeholder="Duration /*number in days"
        ...
        <v-col cols="12">
          <v-textarea flat solo counter no-resize full-width height="100" :rules="rules" :maxlength="max"
            ...
            v-model="transaction.updateTransactionCredential.description"></v-textarea>
        </v-col>
        <v-col cols="12">
          <v-file-input solo flat hide-details placeholder="image" class="realFileInput" background-color="#F4F7F8"
    ...
    <template #footer>
      <div class="con-footer">
        ...
        <div class="con-footer d-flex justify-end">
          ...
          <vs-button color="#6200EA" class="font-weight-bold" @click="updateTransaction"
