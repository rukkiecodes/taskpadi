    ...
    <vs-dialog not-center width="460px" prevent-close blur v-model="product.createProductDialog">
      ...
      <div class="con-form">
        <v-row justify="space-between" align="start">
          <v-col cols="12">
            <vs-input block placeholder="Product name" v-model="product.createProductCredential.name" />
          </v-col>
          <v-col cols="12" sm="6">
            <vs-input block placeholder="Price" v-model="product.createProductCredential.price" />
          </v-col>
          <v-col cols="12" sm="6">
            <vs-input block placeholder="Quantity" v-model="product.createProductCredential.quantity" />
          </v-col>
          <v-col cols="12">
          ...
          <v-col cols="12">
            <v-file-input solo flat dense placeholder="Image" class="realFileInput" @change="setProductImage"
