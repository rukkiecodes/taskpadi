<template>
  <v-sheet color="white" class="head">
    <v-img
      :src="bg"
      :lazy-src="bg"
      class="d-flex align-center background"
      :class="autoOverflow"
    >
      <v-container>
        <v-row
          class="flex-column-reverse  justify-space-between flex-sm-row"
          justify="space-between"
          align="center"
        >
          <v-col class="backgroundText" cols="12" sm="6">
            <v-card :width="textCardWidth" color="transparent" flat>
              <v-card-text
