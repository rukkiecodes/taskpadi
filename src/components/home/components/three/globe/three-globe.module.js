...
var GlobeLayerKapsule = Kapsule({
  ...
  stateInit: function stateInit() {
    ...
    var graticulesObj = new THREE$c.LineSegments(new GeoJsonGeometry(geoGraticule10(), GLOBE_RADIUS, 2), new THREE$c.LineBasicMaterial({
      color: 'lightgrey',
      transparent: true,
      opacity: 0.1
    }));
    ...
    var initGlobe = function initGlobe() {
      if (animateIn) {
        ...
        new TWEEN.Tween({
          ...
          k: 1
        }, 600).easing(TWEEN.Easing.Quadratic.Out).onUpdate(function (_ref14) {
          var k = _ref14.k;
        ...
        new TWEEN.Tween({
          ...
          rot: 0
        }, 1200).easing(TWEEN.Easing.Quintic.Out).onUpdate(function (_ref15) {
          var rot = _ref15.rot;
